                                   ...
                                   {/* {alerts.slice().reverse().map((alert, index) => (
                                      ...
                                      {alerts.slice().reverse().map((alert, index) => (
                                        <Grid key={index} container style={{ border: '2px solid #ccc', borderRadius: '5px', position: 'relative' }}>
                                            <Grid item lg={4} md={4} sm={4} xs={12} style={{ backgroundColor: 'white', margin: 0 }}>
                                                <Grid container spacing={gridSpacing}>
                                                    <Grid item lg={12} md={12} sm={12} xs={12}>
                                            ...
                                            <Grid item lg={4} md={4} sm={4} xs={12} style={{ position: 'relative', backgroundColor: alert.buyInitiateColor, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                <Grid container spacing={gridSpacing}>
                                                    <Grid item lg={12} md={12} sm={12} xs={12}>
                                            ...
                                            <Grid item lg={4} md={4} sm={4} xs={12} style={{ position: 'relative', backgroundColor: alert.buyTargetColor, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                <Grid container spacing={gridSpacing}>
                                                    <Grid item lg={12} md={12} sm={12} xs={12}>
                                                        <p style={{ fontSize: 15, marginLeft:10, fontWeight: 500, textAlign: 'center' }}>
