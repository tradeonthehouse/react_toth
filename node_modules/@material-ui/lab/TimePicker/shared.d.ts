...
export declare function useTimePickerDefaultizedProps<Props extends BaseTimePickerProps<unknown>>({ ampm, components, inputFormat, maxTime, minTime, openTo, views, ...other }: Props, name: string): DefaultizedProps<Props>;
export {};
